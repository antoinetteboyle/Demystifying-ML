...
//Read the data
d3.json("/assets/data/cba.csv").then( function(data) {
// d3.csv("../data/cba.csv").then( function(data) {
 ...
 const showTooltip = function(event, d) {
   ...
   tooltip
     .style("opacity", 1)
     .html(`${d.Date}<br>${chosenXAxis.toUpperCase()}: ${d[chosenXAxis]}<br>${chosenYAxis.toUpperCase()}: ${d[chosenYAxis]}`)
...
var openLabel = ylabelsGroup.append("text")
.attr("x", 40)
.attr("y", -40)
.attr("class", "ylabels")
...
var highLabel = ylabelsGroup.append("text")
.attr("x", 40)
.attr("y", -20)
.attr("class", "ylabels")
...
var closeLabel = ylabelsGroup.append("text")
.attr("x", 40)
.attr("y", 0)
.attr("class", "ylabels")
...
var rbaLabel = xlabelsGroup.append("text")
.attr("x", 0)
.attr("y", 50)
.attr("class", "xlabels")
...
var fedLabel = xlabelsGroup.append("text")
.attr("x", 0)
.attr("y", 70)
.attr("class", "xlabels")
